// src/lib.rs
/*
 * Core library for TypesenseFast
 */
...
#[derive(Debug)]
pub struct TypesenseFastProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TypesenseFastProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TypesenseFast processing");
    
    let mut processor = TypesenseFastProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TypesenseFastProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TypesenseFastProcessor::new(false);
